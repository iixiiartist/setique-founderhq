...
export const FinancialForecastingModule: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-6 border-2 border-black shadow-neo">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-gray-600">Current Cash</h3>
              </div>
              <p className="text-3xl font-bold">{formatCurrency(runwayData.currentCash)}</p>
            </div>

            <div className="bg-white p-6 border-2 border-black shadow-neo">
              <div className="flex items-center gap-2 mb-2">
                <TrendingUp className="w-5 h-5 text-red-600" />
                <h3 className="font-semibold text-gray-600">Monthly Burn Rate</h3>
              </div>
              <p className="text-3xl font-bold">{formatCurrency(runwayData.monthlyBurnRate)}</p>
            </div>

            <div className="bg-white p-6 border-2 border-black shadow-neo">
              <div className="flex items-center gap-2 mb-2">
                <Calendar className="w-5 h-5 text-blue-600" />
                <h3 className="font-semibold text-gray-600">Runway</h3>
              </div>
      ...
      {activeTab === 'revenue' && (
        <div className="bg-white p-6 border-2 border-black shadow-neo">
          <h3 className="text-xl font-semibold mb-4">Revenue Projections (6 Months)</h3>
              ...
              <tbody>
                {revenueProjections.map((projection, index) => (
                  <tr key={index} className="border-t-2 border-black">
                    <td className="p-3 font-semibold">{projection.month}</td>
      ...
      {activeTab === 'cashflow' && (
        <div className="bg-white p-6 border-2 border-black shadow-neo">
          <h3 className="text-xl font-semibold mb-4">Cash Flow Forecast (6 Months)</h3>
          <div className="overflow-x-auto">
            <table className="w-full border-2 border-black">
              <thead className="bg-black text-white">
                <tr>
              ...
              <tbody>
                {cashFlowForecast.map((forecast, index) => (
                  <tr key={index} className="border-t-2 border-black">
                    <td className="p-3 font-semibold">{forecast.month}</td>
                    <td className="p-3 text-right font-mono">
