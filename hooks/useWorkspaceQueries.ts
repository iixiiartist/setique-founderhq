  ...
  return useQuery({
    ...
    queryFn: async (): Promise<BusinessProfile | null> => {
      ...
      return {
        ...
        targetCustomerProfile: profile.target_customer_profile,
        ...
        monetizationModel: profile.monetization_model,
        pricingTiers: profile.pricing_tiers || [],
        dealTypes: profile.deal_types || [],
        averageDealSize: profile.average_deal_size ? Number(profile.average_deal_size) : undefined,
        salesCycleDays: profile.sales_cycle_days || undefined,
        coreProducts: profile.core_products || [],
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const dbData = {
        ...
        target_customer_profile: profileData.targetCustomerProfile,
        competitive_advantages: profileData.competitiveAdvantages,
        key_differentiators: profileData.keyDifferentiators,
        market_positioning: profileData.marketPositioning,
        monetization_model: profileData.monetizationModel,
        pricing_tiers: profileData.pricingTiers,
        deal_types: profileData.dealTypes,
        average_deal_size: profileData.averageDealSize,
        sales_cycle_days: profileData.salesCycleDays,
        core_products: profileData.coreProducts,
        service_offerings: profileData.serviceOfferings,
