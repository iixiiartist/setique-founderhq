...
-- Step 3: Drop existing policies if they exist (for clean re-runs)
...
-- Step 4: Allow authenticated users to upload images to their workspace folders
...
-- Step 5: Allow public read access to all images
...
-- Step 6: Allow users to delete images from their workspace
