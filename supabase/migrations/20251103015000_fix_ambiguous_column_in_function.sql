-- Fix ambiguous column reference in get_workspace_members_with_profiles function
...
BEGIN
    ...
    -- Return members with their profiles (fully qualify all column names)
    RETURN QUERY
    SELECT 
        wm.id as id,
...
BEGIN
    ...
    RAISE NOTICE '=======================================================';
    RAISE NOTICE '✓ Fully qualified all column names with table aliases';
    RAISE NOTICE '=======================================================';
END $$;
