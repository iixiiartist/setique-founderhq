-- Force recreate the function with correct aliases
-- Migration: 20251103020000_force_fix_rpc_function.sql
...
BEGIN
    ...
    -- Return members with their profiles (fully qualify all column names to avoid ambiguity)
    RETURN QUERY
    SELECT 
        wm.id as id,
...
BEGIN
    RAISE NOTICE '=======================================================';
    RAISE NOTICE 'Force Fixed: RPC Function Ambiguous Columns';
    RAISE NOTICE '=======================================================';
    RAISE NOTICE '✓ Dropped and recreated function with explicit aliases';
    RAISE NOTICE '✓ All columns fully qualified: wm.id as id, p.id as profile_id';
    RAISE NOTICE '=======================================================';
END $$;
