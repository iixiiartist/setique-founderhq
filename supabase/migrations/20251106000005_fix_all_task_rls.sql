...
DROP POLICY IF EXISTS "workspace_members_can_view_tasks" ON tasks;
DROP POLICY IF EXISTS "workspace_members_can_insert_tasks" ON tasks;
DROP POLICY IF EXISTS "workspace_members_can_update_tasks" ON tasks;
DROP POLICY IF EXISTS "workspace_members_can_delete_tasks" ON tasks;
