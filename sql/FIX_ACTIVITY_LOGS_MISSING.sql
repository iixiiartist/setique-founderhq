-- FIX: activity_logs table is missing but triggers are trying to write to it
-- This causes task creation to fail with error: relation "activity_logs" does not exist
--
-- Choose ONE of the following options:

-- ============================================================================
-- OPTION 1: Create the activity_logs table (RECOMMENDED)
-- This enables the activity logging feature for team collaboration
-- ============================================================================
...
-- ============================================================================
-- OPTION 2: Remove the triggers (Use this if you don't want activity logging)
...
-- DROP FUNCTION IF EXISTS log_deal_activity();
-- DROP FUNCTION IF EXISTS log_contact_activity();

-- ============================================================================
-- VERIFICATION: Run this to check if the fix worked
-- ============================================================================
