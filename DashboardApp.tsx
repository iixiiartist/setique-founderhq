    ...
    return (
        <>
            ...
            <div className="min-h-screen p-3 sm:p-4 md:p-8">
                ...
                {isLoading ? (
                     <div className="flex flex-col justify-center items-center h-64 gap-4" role="status" aria-live="polite" aria-label="Loading dashboard">
                        ...
                        <span className="text-black font-mono text-sm">Connecting to dashboard...</span>
                    </div>
                ) : (
